...
namespace Rook01.Filters.Authentication
{
    public class CheckTokenFilterFactory : Attribute, IFilterFactory
    {
        ...
        public IFilterMetadata CreateInstance(IServiceProvider serviceProvider)
        {
            ...
            var dapper = serviceProvider.GetService<DataContextDapper>();
    ...
    public class CheckTokenFilter : IAsyncAuthorizationFilter
    {
        ...
        public CheckTokenFilter(ILoggerFactory? logger, DataContextDapper dapper)
        {
            this._logger = logger;
            this._dapper = dapper;
        }
